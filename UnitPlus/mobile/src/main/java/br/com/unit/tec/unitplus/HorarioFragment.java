...
import br.com.unit.tec.unitplus.tasks.HorariosTask;


public class HorarioFragment extends android.support.v4.app.Fragment implements IConsult{
    ...
    private void loadHorarios() {
        showProgress(true);
        HorariosTask horariosTask = new HorariosTask(this, getActivity());
        horariosTask.execute(diaSemana);
    }
    ...
    public void onConsultSuccess(Object object) {
        showProgress(false);
        HorarioAdapter horarioAdapter = (HorarioAdapter) object;
