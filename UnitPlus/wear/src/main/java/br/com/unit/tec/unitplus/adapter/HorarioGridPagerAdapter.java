...
public class HorarioGridPagerAdapter extends FragmentGridPagerAdapter {
    ...
    public HorarioGridPagerAdapter(Context context, List<Element> elements, FragmentManager fm) {
        super(fm);
